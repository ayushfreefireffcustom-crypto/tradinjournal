  ...
  return (
    <>
      ...
      <nav className="fixed top-0 w-full z-50 bg-surface/70 backdrop-blur-xl border-b border-white/5 h-20">
        <div className="max-w-container-max mx-auto px-margin-desktop flex justify-between items-center h-full">
          <div className="grid grid-cols-3 items-center h-full w-full">
            ...
            <div className="flex justify-center gap-8 items-center hidden md:flex">
              <Link className="font-body-md text-body-md text-primary font-bold border-b-2 border-primary pb-1" href="#">Home</Link>
              <Link className="font-body-md text-body-md text-on-surface-variant hover:text-on-surface transition-colors" href="#">Features</Link>
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-32 px-margin-mobile md:px-margin-desktop overflow-hidden">
          ...
          <div className="z-10 text-center max-w-4xl mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full border border-white/10 bg-white/5 mb-8">
              ...
              <span className="text-on-surface-variant font-label-sm text-label-sm flex items-center">Identify Your Emotional Trading Triggers <ArrowRight className="inline ml-1 w-3 h-3" /></span>
            </div>
        ...
        <section className="py-32 bg-surface-container-lowest border-y border-white/5">
          <div className="max-w-container-max mx-auto px-margin-desktop text-center">
            ...
            <h2 className="font-display-xl text-headline-lg md:text-headline-lg max-w-4xl mx-auto leading-tight text-on-surface-variant">
              TRADINX IS THE NEXT-GEN ANALYTICS LAYER FOR MODERN TRADERS. <span className="text-on-surface">IDENTIFY BIASES, REVIEW REPLAYS, AND MASTER THE MARKET.</span>
            </h2>
          </div>
        </section>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="glass-card p-6 rounded-xl text-left transition-all duration-1000 opacity-100 translate-y-0">
                  <Target className="w-6 h-6 text-on-surface-variant mb-4" />
                ...
                <div className="glass-card p-6 rounded-xl text-left transition-all duration-1000 opacity-100 translate-y-0">
                  <Bookmark className="w-6 h-6 text-on-surface-variant mb-4" />
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 border border-white/5 rounded-xl flex justify-between items-center group hover:bg-white/5 transition-all">
                  <div className="flex gap-4 items-center">
                    <Camera className="w-6 h-6 text-on-surface-variant group-hover:text-on-surface transition-colors" />
                  ...
                  <ChevronDown className="w-5 h-5 text-on-surface-variant group-hover:text-on-surface" />
                </div>
                
                <div className="p-6 border border-white/5 rounded-xl flex justify-between items-center group hover:bg-white/5 transition-all">
                  <div className="flex gap-4 items-center">
                    <BookOpen className="w-6 h-6 text-on-surface-variant group-hover:text-on-surface transition-colors" />
                ...
                <div className="p-6 border border-white/5 rounded-xl flex justify-between items-center group hover:bg-white/5 transition-all">
                  <div className="flex gap-4 items-center">
                    <Brain className="w-6 h-6 text-on-surface-variant group-hover:text-on-surface transition-colors" />
            ...
            <div className="pt-20">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-white/5 transition-colors group cursor-pointer border-b border-white/5">
                  <div className="col-span-1 text-left"><Bookmark className="w-5 h-5 text-on-surface-variant" /></div>
                ...
                {/* Trade Row 2 */}
                <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-white/5 transition-colors group cursor-pointer border-b border-white/5">
                  <div className="col-span-1 text-left"><Star className="w-5 h-5 text-orange-500" /></div>
                  <div className="col-span-4 flex gap-4 items-center text-left">
              ...
              <button className="mt-12 text-on-surface-variant hover:text-on-surface flex items-center gap-2 mx-auto font-label-md text-label-md uppercase tracking-widest">
                SEE FULL JOURNAL <ChevronDown className="w-4 h-4" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-40 bg-background relative">
          <div className="max-w-container-max mx-auto px-margin-desktop flex flex-col md:flex-row gap-gutter">
            ...
            <div className="md:w-1/2 relative mt-12 md:mt-0">
              <div className="glass-card p-8 rounded-2xl border-white/10 relative z-10 scale-90 translate-y-12 shadow-[0_50px_100px_rgba(0,0,0,0.5)] transition-all duration-1000 opacity-100">
        ...
        <section className="py-40 bg-surface-container-low border-y border-white/5">
          <div className="max-w-container-max mx-auto px-margin-desktop">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
              <div className="glass-card p-12 rounded-3xl relative h-full flex flex-col justify-center transition-all duration-1000 opacity-100 translate-y-0 min-h-[300px]">
                <div className="absolute inset-0 w-full h-full opacity-10 bg-primary/20 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] rounded-3xl"></div>
                <div className="relative z-10">
          ...
          <div className="max-w-container-max mx-auto px-margin-desktop relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter max-w-5xl mx-auto">
              ...
              <div className="glass-card p-10 rounded-3xl border-white/5 relative hover:border-white/20 transition-all duration-1000 opacity-100 translate-y-0">
                ...
                <ul className="space-y-4 mb-12">
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> 1 MT5 Account Slot
                  </li>
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> Basic Performance Stats
                  </li>
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> Manual Trade Tagging
                  </li>
                  <li className="flex items-center gap-3 text-label-md opacity-30">
                    <ShieldAlert className="w-5 h-5" /> Behavioral Analytics AI
                  </li>
                </ul>
                <button className="w-full py-4 rounded-xl border border-white/10 font-headline-md text-headline-md hover:bg-white/5 transition-all flex justify-between px-6 items-center">
              ...
              <div className="glass-card p-10 rounded-3xl border-primary bg-primary/5 relative hover:shadow-[0_0_80px_rgba(0,51,173,0.2)] transition-all duration-1000 opacity-100 translate-y-0">
                ...
                <ul className="space-y-4 mb-12">
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> Unlimited Account Slots
                  </li>
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> Advanced Behavioral AI
                  </li>
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> Candle-by-Candle Replay
                  </li>
                  <li className="flex items-center gap-3 text-label-md">
                    <Check className="w-5 h-5 text-primary" /> Emotional Trigger Tracking
                  </li>
                </ul>
                <button className="w-full py-4 bg-primary-container rounded-xl font-headline-md text-headline-md shadow-xl shadow-primary/20 flex justify-between px-6 items-center">
        ...
        <div className="max-w-container-max mx-auto px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-gutter">
          <div className="space-y-12">
            ...
            <div className="flex gap-6">
              <Link className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 transition-all" href="#">
          ...
          <div className="grid grid-cols-2 gap-gutter mt-12 md:mt-0">
            <div className="space-y-4">
              <p className="font-label-md text-label-md text-on-surface font-bold">PLATFORM</p>
              <ul className="space-y-2">
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:text-on-surface transition-colors" href="#">Journal</Link></li>
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:text-on-surface transition-colors" href="#">Pricing</Link></li>
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:text-on-surface transition-colors" href="#">Psychology AI</Link></li>
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:text-on-surface transition-colors" href="#">Support</Link></li>
              </ul>
            </div>
            <div className="space-y-4">
              <p className="font-label-md text-label-md text-on-surface font-bold">RESOURCES</p>
              <ul className="space-y-2">
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:underline" href="#">Help Center</Link></li>
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:underline" href="#">Privacy Policy</Link></li>
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:underline" href="#">Terms of Service</Link></li>
                <li><Link className="font-label-md text-label-md text-on-tertiary-container hover:underline" href="#">Media Kit</Link></li>
              </ul>
            </div>
          </div>
        </div>
        
        <div className="max-w-container-max mx-auto px-margin-desktop mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button 
            className="font-label-md text-label-md text-on-surface-variant hover:text-on-surface transition-colors flex items-center gap-2"
          >
