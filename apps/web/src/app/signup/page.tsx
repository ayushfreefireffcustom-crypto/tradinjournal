    ...
    <div className="min-h-screen flex flex-col selection:bg-primary/30 relative">
      ...
      <header className="fixed top-0 w-full z-50">
        <div className="w-full max-w-[1280px] mx-auto px-6 md:px-16 h-20 flex items-center">
          <Link href="/" className="font-sora text-headline-md font-bold tracking-tighter text-white">
            TradinX
          </Link>
        </div>
      </header>
      ...
      <main className="flex-grow flex items-center justify-center pt-24 pb-12 px-6 md:px-16">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          {/* Left Side: Content */}
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 flex flex-col gap-8">
            <div>
              <h1 className="font-sora text-headline-lg-mobile md:text-headline-lg font-bold text-white mb-6">
                Master Your <span className="text-primary-fixed-dim">Trading Psychology</span>
              </h1>
              <p className="font-sora text-body-lg text-on-surface-variant max-w-lg">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sora text-body-md font-bold text-white mb-1">Seamless Syncing</h3>
                  <p className="font-sora text-label-md text-on-surface-variant">Connect your XM or MT5 broker accounts. Your trades sync automatically for instant analysis.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sora text-body-md font-bold text-white mb-1">Deep Performance Metrics</h3>
                  <p className="font-sora text-label-md text-on-surface-variant">Analyze drawdowns, win rates, and equity curves with institutional-grade precision.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sora text-body-md font-bold text-white mb-1">Behavioral AI Insights</h3>
                  <p className="font-sora text-label-md text-on-surface-variant">Identify psychological triggers and emotional patterns to eliminate overtrading and costly habits.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md mx-auto lg:ml-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="glass-card rounded-xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center mb-6">
                  <h2 className="font-sora text-on-surface mb-1 text-headline-md">Create Account</h2>
                  <p className="font-sora text-label-sm text-on-surface-variant">Start your journey to precision trading.</p>
                </div>

                {/* Sign Up Form */}
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label htmlFor="name" className="block font-sora text-label-sm text-on-surface-variant mb-1 ml-1">Full Name</label>
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="neo-input w-full pl-10 pr-4 py-2.5 rounded-lg font-sora text-body-md text-on-surface placeholder:text-outline/50 bg-surface-container-low" 
                      />
                    </div>
                  </div>

                  <div>
                    <label htmlFor="email" className="block font-sora text-label-sm text-on-surface-variant mb-1 ml-1">Email Address</label>
                    <div className="relative">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1 ml-1">
                      <label htmlFor="password" className="font-sora text-label-sm text-on-surface-variant">Password</label>
                    </div>
                    <div className="relative">
                  ...
                  {error && <div className="text-red-500 font-sora text-sm">{error}</div>}
                  <button 
                    type="submit"
                    disabled={isSubmitting || isSuccess}
                    className={`w-full py-3 font-sora text-label-md rounded-lg primary-btn-glow transition-all duration-300 flex justify-center items-center gap-2 mt-6 text-white ${
                ...
                <div className="grid gap-4">
                  <button type="button" onClick={handleGoogle} disabled={isSubmitting || isSuccess || googleLoading} className="w-full py-3 glass-card rounded-lg flex justify-center items-center gap-3 hover:bg-white/5 duration-300 border border-outline-variant/20">
                    ...
                    <span className="font-sora text-label-md text-on-surface">Sign up with Google</span>
                  </button>
                </div>

                {/* Footer Link */}
                <div className="mt-8 text-center">
                  <p className="font-sora text-on-surface-variant text-label-sm">
            ...
            {/* Trust Badge */}
            <div className="mt-8 text-center">
              <p className="font-sora text-label-sm text-on-surface-variant">
