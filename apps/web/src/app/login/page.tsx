...
<input className="neo-input w-full pl-10 pr-4 py-2.5 rounded-lg font-body-md text-body-md text-on-surface placeholder:text-outline/50 bg-surface-container-low" id="email" name="email" placeholder="name@company.com" required type="email" />
</div>
</div>
<div>
...
<input className="neo-input w-full pl-10 pr-4 py-2.5 rounded-lg font-body-md text-body-md text-on-surface placeholder:text-outline/50 bg-surface-container-low" id="password" name="password" placeholder="••••••••" required type="password" />
</div>
</div>
...
<button className="w-full py-3 bg-primary-container font-label-md text-label-md rounded-lg primary-btn-glow transition-all duration-300 flex justify-center items-center gap-2 text-white" type="submit">Sign In <span className="material-symbols-outlined text-md">arrow_forward</span></button>
</form>
{/*  Divider  */}
...
<button className="w-full py-3 glass-card rounded-lg flex justify-center items-center gap-3 hover:bg-white/5 duration-300 border border-outline-variant/20">
...
<p className="font-body-md text-on-surface-variant text-label-sm">
                            ...
                            <a className="text-primary font-bold hover:text-primary-fixed transition-colors" href="#">Sign Up</a>
</p>
</div>
</div></div>
{/*  Trust Badge  */}
