...
export default function RegisterPage() {
  ...
  const inputClass = "w-full px-3 py-2.5 rounded-xl border text-sm outline-none transition-all duration-150";
      ...
      <div className="w-full max-w-sm animate-fade-in-scale">
        ...
        <div className="rounded-2xl p-6 border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-xl border text-sm font-medium transition-all duration-150 disabled:opacity-50"
          ...
          <form onSubmit={handleSubmit} className={`space-y-4 ${shake ? 'animate-shake' : ''}`}>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl text-sm font-semibold transition-all duration-150 disabled:opacity-60"
